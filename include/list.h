#if !defined(SELFORGANIZING_LIST_H)
	 #define SELFORGANIZING_LIST_H
...
namespace find_policy
{
	struct count
	{
		...
		static typename Impl::iterator find(Impl& impl, const T& value)
		{
			...
			while(i != impl.end() && i->second != value)
			{
				++i;
...
template<typename T>
class list<T, find_policy::count, insertion_policy::count>
{
	typedef std::list<std::pair<size_t, T>> impl_type;
...
public:
	...
	{
		typedef typename list<U, find_policy::count, insertion_policy::count>::impl_type::const_iterator impl_type;
	...
	public:
		...
		const_iterator(typename list<U, find_policy::count, insertion_policy::count>::impl_type::iterator i) : i(i)
		{
			int k = 22;
		}
	...
	class iterator
	{
		typedef typename list<U, find_policy::count, insertion_policy::count>::impl_type::iterator impl_type;
		typename impl_type i;
